...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-wrapper sign up">
      <form class="registration1" id="registration" method="post" action="driverLogin" onsubmit="return formValidation()">
        <h1 style="font-size: 30px;">DRIVER LOGIN</h1>
        <div class="input-box">
        ...
        <div class="signIn-link">
          <p>Do not have an account?<a href="DriverRegister.jsp"class="signInBtn"> Sign Up</a>
        </p>
        </div>
      </form>
    </div>
