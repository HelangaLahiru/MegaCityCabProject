...
<%
    try {
        ...
        String query = "SELECT booking_table.Booking_ID, booking_table.Car_Name, booking_table.Car_Brand, " +
                       "booking_table.Car_Number_Plate, booking_table.Car_Colour, booking_table.Driver_Name, " +
                       "booking_table.Driver_Telephone_Number, booking_table.Car_Booking_Price, " +
                       "booking_table.User_Telephone_Number, booking_table.User_Username, booking_table.User_Address, " +
                       "booking_table.User_Current_Location, booking_table.User_Destination, " +
                       "booking_table.Booked_Date, booking_table.Booked_Time, booking_table.Hire_Charge, " +
                       "booking_table.Total_Payable_Amount, booking_table.Journey_Status, booking_table.Car_ID, car_table.Car_Status " +
                       "FROM booking_table " +
        ...
        <tr>
        	<td>
        		<form action="finishTheJourney" method="POST">
            		<button type="submit" class="read-more-button">Finish Journey</button>
            ...
            <td><%= rs.getDouble("Car_Booking_Price") %></td>
